...
`SportsbookProvider` defines health, normalized event snapshots, ticket acceptance/cancellation and incremental settlement updates. A production adapter must additionally satisfy the operational semantics already assumed by the foundation:
