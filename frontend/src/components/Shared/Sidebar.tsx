...
export const Sidebar = () => {
  ...
  return (
    <>
      <style jsx>{`
        /* Personalização da Scrollbar Neon */
        aside::-webkit-scrollbar {
          width: 6px; /* Um pouco mais larga para ser visível */
        }
        
        aside::-webkit-scrollbar-track {
          background: #0a0d14; /* Fundo do trilho muito escuro */
        }
        
        aside::-webkit-scrollbar-thumb {
          background-color: #3b82f6; /* Azul Neon (Blue-500) */
          border-radius: 10px;
          border: 1px solid #0c0f17; /* Pequena borda para separar */
        }
        
        aside::-webkit-scrollbar-thumb:hover {
          background-color: #60a5fa; /* Azul mais claro ao passar o rato (Blue-400) */
          box-shadow: 0 0 10px rgba(59, 130, 246, 0.5); /* Efeito de brilho */
        }
      `}</style>

      {/* Sidebar (Margens e larguras mantidas: w-56) */}
            ...
            {GAMES.map((game) => {
              ...
              return (
                ...
                >
                  ...
                  <span className={`text-lg drop-shadow-md group-hover:scale-110 transition-transform ${game.color}`}>
                    {game.icon}
                  </span>
